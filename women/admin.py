...
class WomenAdmin(admin.ModelAdmin):
    ...
    list_editable = ('is_published',)  # Запятая, так как это кортеж.
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name',)  # Запятая, так как это кортеж.
    prepopulated_fields = {'slug': ('name',)}


admin.site.register(Women, WomenAdmin)  # Регистрируем модель в админ-панели.
