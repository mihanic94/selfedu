...
class Women(models.Model):
    ...
    class Meta:  # Настраиваем то, как будет отображаться модель в панели администратора.
        ...
        ordering = [
                    '-time_create',
                    'title'
        ]  # '-' - сортировка в обратном порядке. Сначала сортируется по первому полю, потом - по второму.
        # В таком порядке записи будут идти не только в админ-панели, но и на сайте и в терминале.
